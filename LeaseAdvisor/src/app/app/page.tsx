...
type LeaseAnalysis = {
  ...
  importantInfo?: string[]; // Jiyuan's version: Important Information in the Rental Contract
  easilyForgotten?: string[]; // Jiyuan's version: Important Information Tenants Often Forget
  legalInfo?: string[]; // Jiyuan's version: Important Local Legal Information
  keyClauses?: string[];
  hiddenFees?: string[];
  tenantRisks?: string[];
        ...
        {tab === "lease" && (
          <section className="mt-4 grid gap-4 md:grid-cols-[minmax(0,1.3fr)_minmax(0,1.7fr)]">
            <div className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
              <h2 className="text-sm font-semibold text-slate-900 md:text-base">
                Lease Advisor (Jiyuan&apos;s Version)
              </h2>
              <p className="mt-1 text-xs text-slate-600 md:text-sm">
                We&apos;ll analyze your lease and provide comprehensive advice including important contract terms, easily overlooked details, and location-specific legal information. This is not legal advice, but a tenant-friendly summary you can take to a lawyer or advisor.
              </p>

              {/* Input Method Selector */}
              <div className="mt-4 flex gap-2 rounded-full bg-slate-100 p-1 text-[11px] md:text-xs">
                <button
                  type="button"
              ...
              <div className="mt-4">
                ...
                <p className="mt-1 text-[10px] text-slate-500">
                  Enter the location of your rental property for location-specific legal advice.
                </p>
              </div>
            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
              ...
              {leaseAnalysis && (
                <div className="mt-3 flex flex-col gap-3 text-xs md:text-sm">
                  ...
                  {/* Jiyuan's Version: Important Information in the Rental Contract */}
                  ...
                  {/* Jiyuan's Version: Important Information Tenants Often Forget */}
                  ...
                  {/* Jiyuan's Version: Important Local Legal Information */}
